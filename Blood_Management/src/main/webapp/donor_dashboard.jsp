	...
	<div class="content">
        ...
        <%
        	...
        	try{
    			...
    			PreparedStatement stmt1=con.prepareStatement("SELECT count(*) from blood_donation");
    			...
    			PreparedStatement stmt2=con.prepareStatement("SELECT count(*) from blood_donation where Status='Pending'");
    			...
    			PreparedStatement stmt3=con.prepareStatement("SELECT count(*) from blood_donation where Status='Approved'");
    			...
    			PreparedStatement stmt4=con.prepareStatement("SELECT count(*) from blood_donation where Status='Rejected'");
