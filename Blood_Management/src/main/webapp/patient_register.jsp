...
<body>
	<div class="container">
		...
		<form action='patient_register.jsp' method='post' id="regForm" onsubmit='return validateForm()'>
			<div class="title">
    ...
    font-weight: 510;'>Already have an account?<br>
			<a href="patient_login.jsp" style="text-decoration:none">click here</a> to Login</p>
		</form>
	...
	<%
		...
		if(fullname!=null ||bloodgroup!=null ||address!=null || username!=null || contact!=null || pwd!=null || cnf!=null ){
			...
			try{
				...
				String sql1="INSERT INTO patient_register (Fullname,Username,Blood_Group,Address,ContactNo) Values(?,?,?,?,?)";
				...
				String sql2="INSERT INTO patient_login VALUES(?,?)";
