    ...
    <div class="content">
        ...
        <div class="main-container">
            ...
            if("reject".equals(msg)){
            		...
            		%>
            			<h2 class="donor-heading" id="message" style="color:red;">Request Rejected!! </h2>
            		<% } %>
            <%
            ...
            if("approved".equals(msg)){
            		...
            		%>
            			<h2 class="donor-heading" id="message" style="color:green;">Request Approved!! </h2>
            		<% } %>
            <%
            ...
            if("error".equals(msg)){
            		...
            		%>
            			<h2 class="donor-heading" id="message" style="color:red;">Insufficient blood units!! </h2>
            		<% } %>
                ...
                <table>
                    ...
                    <tbody id='table'>
                        ...
                        try {
                            Class.forName("com.mysql.cj.jdbc.Driver");
                            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/blood_management", "root", "Subham102@");
                            String sql = "select * from blood_request where status='Pending'";
                            PreparedStatement stmt = con.prepareStatement(sql);
                            ResultSet rs = stmt.executeQuery();
                        ...
                        %>
                                <tr>
                                    ...
                                    <td>
                                        <a href="approve_blood_request.jsp?RequestId=<%= rs.getInt(1) %>&BloodgroupId=<%= rs.getString(8) %>&Unit=<%= rs.getString(6) %>" 
                           style="padding: 5px 11px; border-radius:5px;margin-right: 15px; background: #4CAF50; color: white; text-decoration: none;">Approve</a>
                                        <a href="reject_blood_request.jsp?RequestId=<%= rs.getInt(1) %>" style="padding: 4px 14px; background: #f44336; color: white; border: 2px solid #f44336; text-decoration: none; border-radius: 6px; outline: none; font-weight: 510;">Reject</a>
                                    </td>
                                </tr>
                        <%
                            }
