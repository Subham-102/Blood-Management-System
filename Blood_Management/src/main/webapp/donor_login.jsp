...
%>
	...
	<div class="container">
		<form id="loginForm" action="donor_checkLogin" method="post" onsubmit="return validateForm()">
			<div class="title">
				<h1>Donor Login</h1>
			</div>
			...
			<p>Don't have an account?<br><a href="donor_register.jsp" style="text-decoration:none">Register</a> to create new account</p>
		</form>
